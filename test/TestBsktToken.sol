...
contract ExposedBsktToken is BsktToken {
    ...
    function _getQuantities(address token) public returns (uint256, bool) {
        return getQuantities(token);
    }
